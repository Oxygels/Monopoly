...
public class Scenario7 {
    public static void launch() throws MonopolyException {
        ...
        jules.avancer(12);
        assert jules.getPositionCase().getNom().equals("Compagnie d'électricité");
        assert jules.getMontantBillet() == 1452;
        ...
        assert jules.getMontantBillet() == 1452;
        jules.avancer(4);
        assert jules.getPositionCase().getNom().equals("Compagnie des eaux");
        assert jules.getMontantBillet() == 1412;
